...
export const projectsDetails = [
  {
    ...
    projectDesc:
      "Esse projeto foi criado como desafio do curso da rocketSeat, onde aprendi tecnologias como NodeJS e SQLite para o back-end e React e Styled-Components para o front-end",
